...
public struct SwaggerResponse: Codable, Equatable {
    ...
    public var content: [String: SwaggerMediaType]?
    ...
    public var rawLinks: [String: Any]? {
        get { return codableRawLinks?.value as? [String: Any] }
    ...
    public init(
        ...
        content: [String: SwaggerMediaType]? = nil,
