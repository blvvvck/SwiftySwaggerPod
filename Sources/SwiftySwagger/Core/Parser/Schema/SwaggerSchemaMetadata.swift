...
public struct SwaggerSchemaMetadata: Codable, Equatable {
    ...
    public static let empty = SwaggerSchemaMetadata()
    ...
    public var xml: SwaggerComponent<SwaggerSchemaXML>?
    ...
    public init(
        ...
        xml: SwaggerComponent<SwaggerSchemaXML>? = nil,
