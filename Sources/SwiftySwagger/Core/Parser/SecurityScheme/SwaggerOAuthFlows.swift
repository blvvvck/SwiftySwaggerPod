...
public struct SwaggerOAuthFlows: Codable, Equatable {
    ...
    public var authorizationCode: SwaggerOAuthAuthorizationCodeFlow?
    ...
    public var implicit: SwaggerOAuthImplicitFlow?
    ...
    public var clientCredentials: SwaggerOAuthFlow?
    ...
    public var password: SwaggerOAuthFlow?
    ...
    public init(
        authorizationCode: SwaggerOAuthAuthorizationCodeFlow? = nil,
        implicit: SwaggerOAuthImplicitFlow? = nil,
        clientCredentials: SwaggerOAuthFlow? = nil,
        password: SwaggerOAuthFlow? = nil,
